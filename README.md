...
4. Either reference the `src/cs/production/flecs/flecs.csproj` C# project or import the MSBuild `flecs.props` file which is located in the root of this directory to your `.csproj` file to setup everything you need. See the [flecs.csproj](https://github.com/flecs-hub/flecs-cs/blob/main/src/cs/production/flecs/flecs.cs) file for how to import the `flecs.props` directly.
