...
#undef PINVOKE_TARGET_NAME
#undef PINVOKE_TARGET_CPU_X64
#undef PINVOKE_TARGET_CPU_X86
#undef PINVOKE_TARGET_CPU_ARM64
#undef PINVOKE_TARGET_OS_WINDOWS
#undef PINVOKE_TARGET_OS_LINUX
#undef PINVOKE_TARGET_OS_FREEBSD
#undef PINVOKE_TARGET_OS_MACOS
#undef PINVOKE_TARGET_OS_IOS
#undef PINVOKE_TARGET_OS_ANDROID
#undef PINVOKE_TARGET_OS_BROWSER
#undef PINVOKE_TARGET_ENV_MSVC
#undef PINVOKE_TARGET_ENV_GNU
